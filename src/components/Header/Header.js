...
import type { Props } from './Header.types.js';

const Header: ComponentType<Props> = ({}: Props) => {
  return (
    <header className="govuk-header " role="banner" data-module="govuk-header">
      <div className="govuk-header__container govuk-width-container">
        <div className="govuk-header__logo">
          <a href="https://gov.uk" className="govuk-header__link govuk-header__link--homepage">
            <span className="govuk-header__logotype">
              <svg ariaHidden="true" focusable="false" className="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height="30" width="36">
        ...
        <div className="govuk-header__content">
          <a className="govuk-header__link govuk-header__link--service-name" href="/">Coronavirus (COVID-19) cases in the UK</a>
        </div>
      </div>
    </header>
  );
